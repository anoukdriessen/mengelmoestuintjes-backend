...
public class Herb extends Plant {
    ...
    public Herb(Category type, String name, String description, boolean goodForTea) {
    ...
    public boolean getIsGoodForTea() {
        return goodForTea;
    }
